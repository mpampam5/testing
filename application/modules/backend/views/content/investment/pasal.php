...
<h5 class="text-center">P A S A L 2</h5>
<p class="text-center">MASA KONTRAK</p>
<ol style="list-style-type: decimal;text-align:justify;">
  <li>Masa kontrak perjanjian kerja sama ini adalah (6 bulan) terhitung sejak perjanjian ini ditanda tangani (................. s/d .................). </li>
...
<h5 class="text-center">P A S A L 3</h5>
<p class="text-center">PENGHENTIAN PERJANJIAN KERJASAMA</p>
...
<h5 class="text-center">P A S A L 4</h5>
<p class="text-center">KEJADIAN TAK TERDUGA</p>
<ol style="list-style-type: decimal;text-align:justify;">
...
<h5 class="text-center">P A S A L 5</h5>
...
<p class="mt-2" style="text-align:justify;">Demikianlah surat perjanjian kerja sama ini dibuat oleh kedua belah pihak dengan sadar, tanpa paksaan dan itikad yang baik.</p>
