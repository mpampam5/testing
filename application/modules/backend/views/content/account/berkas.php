      ...
      <div class="card-body">
        ...
        <div class="col-sm-12">
          ...
          <div class="col-sm-12 mx-auto text-center">
            <a href="<?=site_url("backend/account")?>" class="btn btn-sm btn-secondary text-white"> Batal</a>
            <button type="submit" id="submit" name="submit" class="btn btn-primary btn-sm"> Update Berkas</button>
          </div>
...
$(function () {
      ...
      fileupload.change(function () {
          ...
          button.prop('disabled',true).html('<div class="spinner-border spinner-border-sm text-white"></div>');

          form_data.append('foto_personal', file_data);

          $.ajax({
              url: '<?=site_url("backend/account/do_upload")?>',
              dataType: 'json',
              cache: false,
              contentType: false,
              processData: false,
  ...
  $(function () {
            ...
            fileupload.change(function () {
                ...
                $.ajax({
                    url: '<?=site_url("backend/account/do_upload_ktp")?>',
                    dataType: 'json',
                    cache: false,
                    contentType: false,
                    processData: false,
        ...
        $(function () {
                ...
                fileupload.change(function () {
                    ...
                    $.ajax({
                        url: '<?=site_url("backend/account/do_upload_rek")?>',
                        dataType: 'json',
                        cache: false,
                        contentType: false,
                        processData: false,
                        ...
                        success: function(json){
                          if (json.success==true) {
                            ...
                            button.prop('disabled',false).html('Upload');
                            $("#image-rek").val("<?=$row->file_foto_rek?>");
